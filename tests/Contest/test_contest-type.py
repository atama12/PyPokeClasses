...
from pokeAPI_Models.Contests import ContestType
import json

# 1. モックデータをファイルから読み込むためのfixture
@pytest.fixture
def mock_response_data():
    with open('tests/Contest/files/contest-type.json', 'r') as file:
...
@pytest.mark.parametrize("property_name, expected_value", [
    ...
    ("berry_flavor.url","https://pokeapi.co/api/v2/berry-flavor/1/"),
    ("id",1),
    ("name","cool"),
    ("names[0].color","aaaa"),
