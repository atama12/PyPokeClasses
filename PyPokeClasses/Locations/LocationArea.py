...
class EncounterMethodRate:
    ...
    @property
    def version_details(self) -> Union[list[EncounterVersionDetails],None]:
...
class LocationArea(BaseModel):
    ...
    @property
    def encounter_method_rates(self) -> Union[list[EncounterMethodRate],None]:
    ...
    @property
    def pokemon_encounters(self) -> Union[list[PokemonEncounter],None]:
